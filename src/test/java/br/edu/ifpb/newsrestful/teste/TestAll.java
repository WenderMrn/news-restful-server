...
public class TestAll{
	...
	public void insertNoticia(){
		...
		int before = newsDAO.findAll().size()+2;
		newsDAO.save(
				new News("Estudante salva homem engasgado antes de entrevista para vaga de paramédico",
						...
						"Maria Carla Andrade"));
		newsDAO.save(
				new News("Após quase 5 meses desaparecido, Bruno Borges retorna para casa no Acre",
						...
						"Maria Carla Andrade"));
		int after = newsDAO.findAll().size();		
